package com.mycompany.poc.config.timezone;

import com.mycompany.poc.SpringbootpocApp;
import com.mycompany.poc.repository.timezone.DateTimeWrapper;
import com.mycompany.poc.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM poc_date_time_wrapper where id=%d", fieldName, id);
    }
