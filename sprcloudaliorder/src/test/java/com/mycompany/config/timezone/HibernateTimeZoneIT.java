...
import com.mycompany.SprcloudaliorderApp;
import com.mycompany.RedisTestContainerExtension;
 ...
 */
@SpringBootTest(classes = SprcloudaliorderApp.class)
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM my_date_time_wrapper where id=%d", fieldName, id);
    }
